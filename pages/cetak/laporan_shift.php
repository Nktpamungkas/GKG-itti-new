    ...
    <table class="table-ttd" style="width:330mm;">
        ...
        <tr>
            ...
            <td colspan="5" height="120px" style="border-left: none;">
              <li> &nbsp;&nbsp;<?php echo $data['absensi_s1'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
                ...
                <li>: <?php echo $data['cuti_s1'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['libur_s1'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['izin_s1'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
            </td>
            <td height="120px" style="border-right: none;">
                <li>Absensi</li>
                <li>Hadir</li>
            ...
            <td colspan="5" height="120px" style="border-left: none;">
                <li> &nbsp;&nbsp;<?php echo $data['absensi_s2'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
                <li>: <?php echo $data['hadir_s2'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['sakit_s2'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['mangkir_s2'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['cuti_s2'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['libur_s2'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['izin_s2'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
            </td>
            <td height="120px" style="border-right: none;">
                <li>Absensi</li>
                <li>Hadir</li>
            ...
            <td colspan="5" height="120px" style="border-left: none;">
                <li> &nbsp;&nbsp;<?php echo $data['absensi_s3'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
                <li>: <?php echo $data['hadir_s3'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['sakit_s3'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['mangkir_s3'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['cuti_s3'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['libur_s3'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
                <li>: <?php echo $data['izin_s3'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang</li>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td height="118px" colspan="3" valign="top" style="border-left:none;">
                ...
                <li><small style="font-weight: bold;">MC JHT PGR &nbsp;&nbsp; : <?php echo $data['jahit_pinggir_s1'] ?></small></li>
            </td>
            <td height="118px" colspan="3" valign="top" style="border-right:none;">
                <li>Lain-lain &nbsp;&nbsp;&nbsp; :</li>
                <li>Terima kain &nbsp;&nbsp; : <?php echo $data['terimakains2'] ?> ORANG</li>
                <li>Inspeksi &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data['inspeksis2'] ?> ORANG</li>
                <li>Bagi kain &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data['bagikains2'] ?> ORANG</li>
                <li>Buka kain &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data['bukakains2'] ?> ORANG</li>
                <li><b>Leader</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data['leader_s2'] ?> ORANG</li>
            ...
            <td height="118px" colspan="3" valign="top" style="border-left:none;">
                ...
                <li><small style="font-weight: bold;">MC JHT PGR &nbsp;&nbsp; : <?php echo $data['jahit_pinggir_s2'] ?></small></li>
            </td>
            <td height="118px" colspan="3" valign="top" style="border-right:none;">
                <li>Lain-lain &nbsp;&nbsp;&nbsp; :</li>
                <li>Terima kain &nbsp;&nbsp; : <?php echo $data['terimakains3'] ?> ORANG</li>
                <li>Inspeksi &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data['inspeksis3'] ?> ORANG</li>
                <li>Bagi kain &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data['bagikains3'] ?> ORANG</li>
                <li>Buka kain &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data['bukakains3'] ?> ORANG</li>
                <li><b>Leader</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data['leader_s3'] ?> ORANG</li>
            ...
            <td height="118px" colspan="3" valign="top" style="border-left:none;">
                ...
                <li><small style="font-weight: bold;">MC JHT PGR &nbsp;&nbsp; : <?php echo $data['jahit_pinggir_s3'] ?></small></li>
            </td>
        </tr>
    </table>
    <br />
