        ...
        <tbody>
            ...
            if ($_GET["shift"] != 'ALL') {
                ...
                $sqlDB21 = "SELECT
                                ...
                                WHERE
                                    (x.OPERATIONCODE = 'BAT2' OR x.OPERATIONCODE = 'BKN1' OR x.OPERATIONCODE = 'BEL1' OR x.OPERATIONCODE = 'BAT3' OR x.OPERATIONCODE = 'BAT1' OR x.OPERATIONCODE = 'BBS1' OR x.OPERATIONCODE = 'JHP1' OR x.OPERATIONCODE = 'WAIT36')
